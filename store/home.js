export const state = () => ({
  ...
  services: [{
    code: `dev`,
    name: `تصميم تطبيقات الجوال وبرمجة المواقع`,
    desc: `بناء المواقع والتطبيقات للإستفادة منها بشكل يؤهلك المنافسة في سوق العمل ويعكس هويتك التجارية.`,
  }, {
    code: `branding`,
    name: `تصميم هوية تجارية `,
    desc: `هويتك هي دليلك لقلب عملائك فكن قريبا منهم واعمل على جذبهم بهوية تعلق في أذهانهم  .`,
  }, {
    code: `marketing`,
    name: `إدارة التسويق الرقمي `,
    desc: `التسويق الرقمي عالم عظيم وبحر كبير تحتاج فيه كيان لارشادك للطريق الصحيح .`,
  }, {
    code: `ads`,
    name: `إنشاء الحملات الإعلانية`,
    desc: `حملتك الإعلانية هو رسالتك للجمهور وجه رسالتك بشكل صحيح لتحصل على ما تريد .`,
  }, {
    code: `content`,
    ...
    code: `motion`,
    name: `انتاج الموشن جرافيك `,
    desc: `الصورة بألف كلمة والفيديو بألف صورة احكي قصتك لتصل فكرتك`,
  }],
  medicals: [
    {
